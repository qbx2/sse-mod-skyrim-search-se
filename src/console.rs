...
pub(crate) unsafe fn init(image_base: usize) -> anyhow::Result<()> {
    let target_addr = transmute(image_base + 0x2fbb00);//1.5.97: 0x2e75f0 -> 1.6.318: 0x2fba00 -> addressLib ID: 21890 -> 1.6.323: 0x2fb970 -> 1.6.342: 0x2fbb00
    ...
    LateStatic::assign(
        &S,
        State {
            console_context: transmute(image_base + 0x2f9b980),//1.5.97: 0x2f000f0 -> 1.6.318: 0x2f9a800 -> addressLib ID: 401203 -> 1.6.323: 0x2f9a800 -> 1.6.342: 0x2f9b980
            print_to_console: transmute(image_base + 0x88a590),//1.5.97: 0x85c290 -> 1.6.318: 0x889650 -> addressLib ID: 51109 -> 1.6.323: 0x8893c0 -> 1.6.342: 0x88a590
