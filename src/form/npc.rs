...
pub(crate) unsafe fn init(image_base: usize) -> anyhow::Result<()> {
    let npc_vtable = transmute(image_base + 0x1698a30);//1.5.97: 0x159fcd0-> 1.6.318: 0x1697a30 -> addressLib ID: 195816 -> 1.6.323: 0x1697a30 -> 1.6.342: 0x1698a30 -> 1.6.353: 0x1698a30
